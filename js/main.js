(() => {
	...
	let itemObjects = [
		...
		new Item(6, Item.RARITY.COMMON, 'Tooth', 'Monster Tooth', 'defense,heal,on,kill', 'monsterTooth', 'Killing an ennemy spawns a {defense:healing orb} that heals for {defense:8} plus an additional {defense:2%} {+2%} of {defense:maximum health}.'),
		...
		new Item(24, Item.RARITY.COMMON, 'LevelBonus', 'Warbanner', 'utility,attack,speed,movespeed,on,level', 'warbanner', 'On {misc:level up} or starting the {misc:Teleporter event}, drop a banner that strengthens all allies within {misc:16m} {+8m}.\nRaise {offense:attack} and {misc:movement speed} by {offense:30%}.'),
		new Item(27, Item.RARITY.COMMON, 'HealWhileSafe', 'Cautious Slug', 'defense,heal', 'slug', 'Increases {defense:base health regeneration} by {defense:+4 hp/s} {+4 hp/s} while outside of combat.'),
		new Item(29, Item.RARITY.COMMON, 'PersonalShield', 'Personal Shield Generator', 'defense,shield', 'shield', 'Gain a {defense:shield} equal to {defense:8%} {+8%} of your maximum healt. Recharges outside of danger.'),
		new Item(36, Item.RARITY.COMMON, 'Medkit', 'Medkit', 'defense,heal,on,hit,locked', 'medkit', '2 seconds after getting hurt, {defense:heal} for {defense:20} plus an additional {defense:5%} {+5%} of {defense:maximum health}.', 'Defeat an Elite-type monster.'),
		...
		new Item(59, Item.RARITY.COMMON, 'StickyBomb', 'Sticky Bomb', 'offense,on,hit', 'stickyBomb', '{offense:5%} {+5%} chance on hit to attach a {offense:bomb} to an enemy, detonating for {offense:180%} TOTAL damage.'),
		...
		new Item(84, Item.RARITY.COMMON, 'BarrierOnKill', 'Topaz Brooch', 'defense,shield,on,kill', 'shieldBrooch', 'Gain a {defense:temporary barrier} on kill for {defense:15 health} {+15}.'),
		...
		// Uncommon
		new Item(3, Item.RARITY.UNCOMMON, 'Missile', 'AtG Missile Mk. 1', 'offense,on,hit', 'missile_mk', '{offense:10%} chance to fire a missile that deals {offense:300%} {+300%} TOTAL damage.'),
		...
		new Item(19, Item.RARITY.UNCOMMON, 'AttackSpeedOnCrit', 'Predatory Instincts', 'offense,critical,locked', 'hat', '{offense:Critical Strikes} increase {offense:attack speed} by {offense:12%}.\nMaximum cap of {offense:36%} {+24%} {offense:attack speed}.', 'Reach +200% attack speed.'),
		...
		new Item(62, Item.RARITY.UNCOMMON, 'SprintArmor', 'Rose Buckler', 'defense,armour,shield', 'buckler', '{defense:Increase armor} by {defense:30} {+30} while {misc:sprinting}.'),
		new Item(63, Item.RARITY.UNCOMMON, 'IceRing', 'Runald\'s Band', 'offense,on,hit,locked', 'iceRing', 'Hits that deals {offense:more than 400% damage} also blasts enemies with a {offense:runic ice blast}, {misc:slowing} them by {misc:80%} for {misc:3s} {+3s} and dealing {offense:250%} {+250%} TOTAL damage. Recharge every {misc:10} seconds.', 'Discover the hidden chamber in the Abandonned Aqueduct.'),
		new Item(64, Item.RARITY.UNCOMMON, 'FireRing', 'Kjaro\'s Band', 'offense,on,hit,locked', 'fireRing', 'Hits that deals {offense:more than 400% damage} also blasts enemies with a {offense:runic flame tornado}, dealing {offense:300%} {+300%} TOTAL damage over time. Recharge every {misc:10} seconds.', 'Discover the hidden chamber in the Abandonned Aqueduct.'),
		...
		new Item(103, Item.RARITY.UNCOMMON, '', 'Squid Polyp', 'offense,summon,turret,squid,auto', 'squidTurret', 'Activating an interactable summons a {offense:Squid Turret} that attacks nearby enemies at {offense:100%} {+100%} {offense:attack speed}. Lasts {misc:30} seconds.', 'Activate 6 turrets in a single run.'),
		...
		new Item(15, Item.RARITY.RARE, 'GhostOnKill', 'Happiest Mask', 'offense,on,kill', 'mask', 'Killing enemies has a {offense:7%} chance to {offense:spawn a ghost} of the killed enemy with {offense:1500%} damage. Lasts {offense:30s} {+30s}.'),
		new Item(22, Item.RARITY.RARE, 'FallBoots', 'H3AD-5T v2', 'defense,attack,fall', 'cuffs', 'Increase {misc:jump height}.\nCreates a {offense:5m-100m} radius {offense:kinetic explosion} on hitting the ground, dealing {offense:1000%-10000%} base damage that scales up with {offense:speed}.\nRecharges in {offense:10} {-50%} seconds.'),
		...
		new Item(32, Item.RARITY.RARE, 'ShockNearby', 'Unstable Tesla Coil', 'offense,close,locked', 'tesla', 'Fire out {offense:lightning} that hits {offense:3} {+2} enemies for {offense:200%} base damage every {offense:0.5s}.\nThe Tesla Coil switches off every {offense:10 seconds}.', 'Deal 5000 damage in one shot.'),
		...
		new Item(70, Item.RARITY.RARE, 'KillEliteFrenzy', 'Brainstalks', 'offense,locked', 'brain', 'Upon killing an elite monster, {offense:enter a frenzy} for {offense:4s} {+4s} where {misc:skills have no cooldowns}.', 'Defeat an Elite boss on Monsoon difficulty.'),
		...
		new Item(80, Item.RARITY.RARE, 'BarrierOnOverHeal', 'Aegis', 'utility,heal,defense', 'fullBarrier', 'Healing past full grants you a {defense:temporary barrier} for up to {defense:50%} {+50%} of the amount you {defense:healed}.'),
		...
		// Unique
		new Item(52, Item.RARITY.UNIQUE, 'Knurl', 'Titanic Knurl', 'defense,life', 'knurl', '{defense:Increases maximum health} by {defense:40} {+40} and {defense:base health regeneration} by {defense:+1.6 hp/s} {+1.6 hp/s}.'),
		...
		new Item(83, Item.RARITY.UNIQUE, 'SprintWisp', 'Little Disciple', 'offense,tracking,sprint,attack', 'sprintingWisp', 'Fire a {offense:tracking wisp} for {offense:300%} {+300%} {offense:damage}.\nFires every 1.6 seconds while sprinting. Fire rate increases with {misc:movement speed}.'),
		...
		new Item(74, Item.RARITY.LUNAR, 'AutoCastEquipment', 'Gesture of the Drowned', 'utility,equipment,locked', 'fossil', '{misc:Reduce equipment cooldown} by {misc:50%} {+15%}.\nForces your Equipment to {misc:activate} whenever it is off {misc:cooldown}.', 'Kill 20 Hermit Crabs by chasing them off the edge of the map.'),
		...
		new Item(107, Item.RARITY.LUNAR, '', 'Focused Convergence', 'utility,teleporter,event,smaller,faster', 'orb', 'Teleporters charge {misc:30%} {+30%} {misc:faster}, but the size of the Teleporter zone is {debuff:50%} {-50%} smaller.', 'In 4 consecutives stages, don\'t leave the teleporter radius until it is fully charged.'),
		...
		new Item(0, Item.RARITY.LUNAR, '', 'Purity', 'utility,cooldown,reduction,bad luck,reroll', 'snowflake', 'All skill cooldowns are reduced by {misc:2} {+1} seconds. All random effects are rolled {misc:+1} {+1} times for an {debuff:unfavorable outcome}.', 'Beat the game in Monsoon difficulty.'),
		...
		new Item(11, Item.RARITY.EQUIPMENT, 'Blackhole', 'Blackhole', 'offense,stack', 'blackhole', 'Fire a black hole that {misc:draws enemies within 30m into it\'s center}. Last 10 seconds.\nCooldown: {misc:60s}'),
